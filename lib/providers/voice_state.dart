...
class VoiceState extends ChangeNotifier with DiagnosticableTreeMixin {
    ...
    try {
      ...
      _voiceRoomListener!
        ...
        ..on<ParticipantConnectedEvent>((e) {
          ...
          _voiceChannelMembers.putIfAbsent(channel.id, () => []);
          if (!_voiceChannelMembers[channel.id]!.contains(
      ...
      // Apply stored output volume and per-participant volumes to remote participants
  ...
  Future<void> _loadSettings() async {
    ...
    _selectedAudioInputId = await asyncPrefs.getString(
  ...
  Future<void> _applyParticipantVolumes() async {
    if (_voiceRoom == null || !_isInVoice) return;
